# -*- coding: utf-8 -*-
"""
Created on Tue Jun 18 18:47:19 2024
...
# # Generate random data: 1000 samples with 768 dimensions
# data = np.random.rand(1000, 768)

# # Initialize the SOM
# som = MiniSom(x=30, y=30, input_len=768, sigma=1.0, learning_rate=0.5)
...
# train_x = np.random.rand(1000, 768)

# # Generate random labels (3 classes)
# train_y = np.random.randint(0, 3, 1000)

# # Generate random testing data: 100 samples with 768 dimensions
# test_x = np.random.rand(100, 768)

# # Generate random labels for testing data (not used in training)
# test_y = np.random.randint(0, 3, 100)
